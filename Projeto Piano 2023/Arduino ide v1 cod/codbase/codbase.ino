...
char keys[ROWS][COLS] = { //DECLARAÇÃO DOS NUMEROS, LETRAS E CARACTERES DO
//TECLADO
{'1','2','3','A'},
{'4','5','6','B'},
{'7','8','9','C'},
...
Keypad keypad = Keypad( makeKeymap(keys), rowPins, colPins, ROWS, COLS );//AS VARIAVEIS rowPins E colPins RECEBERÃO O VALOR DE LEITURA DOS PINOS DAS LINHAS E COLUNAS
//RESPECTIVAMENTE
...
servo_Motor.write(0); //POSIÇÃO DO SERVO FICA EM 0o (FECHADURA TRANCADA)
}
else{ 
